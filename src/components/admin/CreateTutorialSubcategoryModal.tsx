...
import TutorialSubcategoryForm from './TutorialSubcategoryForm';

type Category = { id: number; name: string };

export default function CreateTutorialSubcategoryModal({ categories }: { categories: Category[] }) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/30 backdrop-blur-md">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md relative overflow-hidden">
            <div className="flex justify-between items-center p-4 border-b border-gray-100 bg-gray-50">
              <h3 className="text-[15px] font-bold text-gray-900">Añadir Subcategoría de Tutorial</h3>
            ...
            <div className="p-2">
              <TutorialSubcategoryForm categories={categories} />
            </div>
          </div>
        </div>
      )}
