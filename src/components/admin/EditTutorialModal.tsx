  ...
  return (
    <>
      <button 
        ...
        className="text-[#0d1624] hover:text-[#f04f23] transition-colors p-1.5 rounded-md hover:bg-gray-100 cursor-pointer"
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/30 backdrop-blur-md transition-opacity">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg relative overflow-hidden animate-fade-in-up text-left">
            <div className="flex justify-between items-center p-4 border-b border-gray-100 bg-gray-50">
              <h3 className="text-[15px] font-bold text-gray-900">Editar Tutorial</h3>
              <button 
