        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/30 backdrop-blur-md">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm relative overflow-hidden text-left">
            <div className="p-6">
              ...
              <h3 className="text-lg font-bold text-center text-gray-900 mb-2">¿Eliminar Proyecto?</h3>
              <p className="text-sm text-center text-gray-500">
                ¿Estás seguro de que deseas eliminar el proyecto <span className="font-bold">"{title}"</span>? Esta acción no se puede deshacer.
              </p>
            </div>
